...
<body style="background-color: white;">
	<div class="page_top">
		...
		<div class="page_right">
			...
			<a href="denglu">登录</a><span class="sep">|</span> <a href="zhuce">注册</a><span
				class="sep">|</span> <a href="top/dizhi">收货地址</a><span class="sep">|</span>
			<a href="top/car"><img
				src="img/shopping_cart_72px_1221355_easyicon.net.ico"
    ...
    <h3>
     确认收货地址 <span class="manage-address">
      <button title="修改地址" class="J_MakePoint layui-btn layui-btn-warm" onclick="adddz()"
        href="JavaScript:void(0);">新增地址<tton>
     </span>
    </h3>
    <div id="orderdz">
							...
							<c:forEach items="${list}" var="list">
								<tr class="item" data-pointRate="0">
									<td class="s-title"><a href="#" class="J_MakePoint"> <img
											...
											class="title J_MakePoint">${list.proname}</span></a>
										<div class="props">
											<span>手机套餐: 标准 </span><span>版本: 中国大陆 </span>
									...
									<td class="s-total shoplist" style="text-align: center">
										...
										<div class="J_AddressConfirm address-confirm">
											<div class="kd-popup pop-back" style="margin-bottom: 40px;">
												...
												<a id="J_Go" class=" btn-go" data-point-url="" tabindex="0"
													title="点击此按钮，提交订单。" onclick="tijiao()"  href="fukuan1">提交订单<b
	...
	<br>
	<div class="ending" style="background-color: white;"></div>
	...
	window.onload = function() {
	 ...
	 function adddz() {
		...
		/**function xuanze() {
			var radioName = $("input[name='classId']:checked")[0].nextSibling.nodeValue;
		 ...
		 function tijiao() {
			...
			if (val == null) {
				...
				$('.shoplist').each(function(index) {
					row1.push($(this).find('[name="shuliang"]').val());
					row2.push($(this).find('[name="goodsid"]').val());
					row3.push($(this).find('[name="imgname"]').val());
					row4.push($(this).find('[name="xiaoji"]').text());
					row5.push($(this).find('[name="comname"]').val());
				});
				...
				for (var i = 0; i < row1.length; i++) {
					...
					$.ajax({
						...
						url : "top/car_fukuan",
						data : {
							"order_goodsid" : goodsid,
							"order_number" : shuliang,
							"order_money" : xiaoji,
							"order_goodsname" : imgname,
							"order_dz" : shdz,
				...
				form.attr('action', 'top/car_fukuan');
