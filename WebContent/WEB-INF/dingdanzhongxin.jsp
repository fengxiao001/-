...
<link rel="stylesheet" type="text/css" href="layui/style.css">
<body>
			<header>
...
<!-- self_info -->
	<div class="grzxbj">
		...
		<div class="rtcont fr">
			...
			<div class="ddxq">
			<c:forEach  items="${checkding}" var="ding">
				<div class="ddspt fl"><img style="height:83px;width:82px" src="file/${ding.imgname}" alt=""></div>
